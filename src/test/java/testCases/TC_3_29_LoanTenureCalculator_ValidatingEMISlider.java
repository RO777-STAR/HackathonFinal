	...
	public void validatingEMISlider() {
		...
		try {
			...
			if(obj1.getEMISlider().isDisplayed()) {
				...
				logger.error("TC_3_29 got failed, EMI Slider is not visible.");
				System.out.println("TC_3_29 got failed, EMI Slider is not visible.");
				myAssert.fail();
			}
			...
			if(obj1.getEMISlider().isEnabled()) {
				...
				logger.error("TC_3_29 got failed, EMI Slider is not enabled.");
				System.out.println("TC_3_29 got failed, EMI Slider is not enabled.");
				myAssert.fail();
			}
		}
		catch(Exception e) {
