...
public class TC_3_36_LoanTenure_CalculatorIntegressionTestingForFeesAndChargesTextBoxAndSlider extends BaseClass{
	AddFluentWait wait = new AddFluentWait();
	Assertions myAssert = new Assertions();
	@Test
	public void validatingDataFlowBetweenFeesAndChargesSliderAndTextBox() {
		
		logger.info("**** TC_3_36_LoanTenure_CalculatorIntegressionTestingForFeesAndChargesTextBoxAndSlider Started ****");
		try {
			...
			if(obj1.getFeesAndChargesTextBoxValue().equals("25,000")) {
				...
				logger.error("TC_3_36 got failed, Integration Testing for Fees And Charges Text Box "
						+ "and slider was not successful");
				System.out.println("TC_3_36 got failed, Integration Testing for Fees And Charges Text "
			...
			logger.error("TC_3_36 got failed, Integration Testing for Fees And Charges Text Box ans Slider was not successful");
			myAssert.fail();
		}
		
		logger.info("**** TC_3_36_LoanTenure_CalculatorIntegressionTestingForFeesAndChargesTextBoxAndSlider Ended ****");
	}
}
